        ...
        <div class="col-md-8">
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="/Category/update" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   id="name" 
                                   name="name" 
                                   value="<?php echo htmlspecialchars($old['name'] ?? $category->name, ENT_QUOTES, 'UTF-8'); ?>"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control form-control-lg <?php echo isset($errors['description']) ? 'is-invalid' : ''; ?>" 
                                      ...
                                      required><?php echo htmlspecialchars($old['description'] ?? $category->description, ENT_QUOTES, 'UTF-8'); ?></textarea>
